...
test_that("Output dataframe has expected column names", {
  ...
  expect_named(ForestStr(data = good_comp_metric_no_ht,
                         units = "metric"),
  ...
  expect_named(ForestStr(data = good_comp_imperial_no_ht,
                         units = "imperial"),
...
test_that("Package and hand calculations match", {
  ...
  # metric
  str_m_package <- ForestStr(comp_str_trees_m, units = "metric")
  ...
  # imperial
  str_i_package <- ForestStr(comp_str_trees_i, units = "imperial")
