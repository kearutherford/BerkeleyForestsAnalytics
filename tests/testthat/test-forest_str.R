...
test_that("Final column classes are as expected", {
  ...
  trial <- ForestStr(data = good_comp_metric,
                     site = "Forest",
                     plot = "Plot_id",
                     exp_factor = "SPH",
                     dbh = "DBH_CM",
  ...
  expect_equal(class(trial$sph), "numeric")
  expect_equal(class(trial$ba_m2_ha), "numeric")
  expect_equal(class(trial$qmd_cm), "numeric")
  expect_equal(class(trial$dbh_cm), "numeric")
  expect_equal(class(trial$ht_m), "numeric")
