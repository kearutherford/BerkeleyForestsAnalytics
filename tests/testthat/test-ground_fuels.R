...
test_that("Properly formatted data frames throw no error, warnings, or messages", {
  ...
  expect_no_error(ValidateGround(fuel_data_val = good_duff_m,
                                 units_val = "metric",
                                 meas_val = "separate"))

  expect_no_warning(ValidateGround(fuel_data_val = good_duff_m,
                                   units_val = "metric",
                                   meas_val = "separate"))

  expect_no_message(ValidateGround(fuel_data_val = good_duff_m,
                                   units_val = "metric",
                                   meas_val = "separate"))
...
test_that("Dataframe has expected column names", {
  ...
  expect_named(ValidateGround(fuel_data_val = good_duff_m,
                              units_val = "metric",
                              meas_val = "separate"),
...
test_that("Invalid settings throw an error", {
  ...
  expect_error(ValidateGround(fuel_data_val = good_duff_m,
                              units_val = "m",
                              meas_val = "separate"),
...
test_that("Missing columns throw an error", {
  ...
  expect_error(ValidateGround(fuel_data_val = bad_duff_1,
                              units_val = "metric",
                              meas_val = "separate"),
...
test_that("Missing id information throws an error", {
  ...
  expect_error(ValidateGround(fuel_data_val = bad_duff_2,
                              units_val = "metric",
                              meas_val = "separate"),
               'For fuel_data, there are missing values in the time column.')

  expect_error(ValidateGround(fuel_data_val = bad_duff_3,
                              units_val = "metric",
                              meas_val = "separate"),
               'For fuel_data, there are missing values in the site column.')

  expect_error(ValidateGround(fuel_data_val = bad_duff_4,
                              units_val = "metric",
                              meas_val = "separate"),
               'For fuel_data, there are missing values in the plot column.')

  expect_error(ValidateGround(fuel_data_val = bad_duff_5,
                              units_val = "metric",
                              meas_val = "separate"),
...
test_that("Output dataframe has expected column names", {
  ...
  expect_named(GroundFuels(fuel_data = good_duff_m,
...
test_that("Final column classes are as expected", {
  ...
  duff_trial1 <- GroundFuels(fuel_data = good_duff_m,
                             tree_data = good_sf_trees_m)

  duff_trial2 <- GroundFuels(fuel_data = good_duff_m,
                             tree_data = good_sf_trees_m,
                             measurement = "combined")
