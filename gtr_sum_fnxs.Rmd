...
BySpSt <- function(data, out_units) {
  ...
  if(out_units == "metric") {
    ...
    colnames(fill_df) <- c("site", "plot", "species", "total_wood_Mg_ha_L", "total_wood_Mg_ha_D")
    ...
    for(f in forests) {
        ...
        for(p in plot_ids) {
            ...
            alert_NA <- all(is.na(all_trees$total_wood))
            ...
            temp_df <- data.frame(site = f,
                                  plot = p,
                                  species = sp_list,
                                  total_wood_Mg_ha_L = 0,
                                  total_wood_Mg_ha_D = 0)
            ...
            # if there are trees in the plot, but all had NA biomass estimates due to missing data
              ...
              temp_df <- data.frame(site = f,
                                    plot = p,
                                    species = sp_list,
                                    total_wood_Mg_ha_L = NA,
                                    total_wood_Mg_ha_D = NA)
            ...
            # there are trees in the plot, and not all had NA biomass estimates
              ...
              for(sp in species_ids) {
                  ...
                  total_wood_L <- round(sum(single_sp_L$total_wood, na.rm = TRUE),2)
                  total_wood_D <- round(sum(single_sp_D$total_wood, na.rm = TRUE),2)

                  temp_df[temp_df$species == sp, "total_wood_Mg_ha_L"] <- total_wood_L
                  temp_df[temp_df$species == sp, "total_wood_Mg_ha_D"] <- total_wood_D
